    ...
    class ModelMembersMeta< TestLHModelNS::ExampleModelA >
    {
        public:
            static constexpr std::array< MemberMeta, 3 > membersMeta{ {
                ...
                MemberMeta( "member3", "NoSuchNS::LHModelTestUUID", "uuid" ) } };
    ...
    class ExampleModelA
    {
        public:
            ...
            void Accept( V& visitor ) const
            {
                ...
                visitor._VisitMember( LHModelNS::GetMemberMeta< ExampleModelA, 2 >(), member3 );
            }
            ...
            NoSuchNS::LHModelTestUUID member3;
    };
}
