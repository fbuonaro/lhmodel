    ...
    class ModelMembersMeta< TestLHModelNS::ExampleModelD >
    {
        public:
            static constexpr std::array< MemberMeta, 3 > membersMeta{ {
                ...
                MemberMeta( "member2", "std::vector<std::vector<std::map<std::string, std::map<std::string, ExampleModelA>>>>", "" ),
                MemberMeta( "member3", "std::map<std::string, std::map<std::string, std::string>>", "" ) } };
...
namespace TestLHModelNS
{
    class ExampleModelD
    {
        public:
            ...
            std::int64_t member1;
            std::vector<std::vector<std::map<std::string, std::map<std::string, ExampleModelA>>>> member2;
            std::map<std::string, std::map<std::string, std::string>> member3;
    };
}
